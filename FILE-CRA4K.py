...
def reg():
    ...
    time.sleep(1) 
    try:
        to = open('/sdcard/Android/.RtZwex6.txt', 'r').read()
    except (KeyError, IOError):
        reg2()
    r = requests.get('https://pastebin.com/raw/ButYRJDw').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        print(' WhatsApp : +92325669420')
        input('\033[1;97m Press Enter To Send Token')
        os.system('xdg-open https://wa.me/+923025669420?text=Assalamualaikum Sir Approve my Token and my Token :'+to)
        reg()
...
def reg2():
    ...
    print (' Token : ' + id)
    print(' WhatsApp : +923025669420')
    input(' Press Enter To Send Token ')
    os.system('xdg-open https://wa.me/+923025669420?text=Assalamualaikum Sir Approve my Token and my Token :'+id)
    sav = open('/sdcard/Android/.RtZwex6.txt', 'w')
    sav.write(id)
    sav.close()
    reg()
